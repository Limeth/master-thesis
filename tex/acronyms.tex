...
\begin{acronym} % keep sorted using :sort
    ...
    \acro{GLSL}{OpenGL Shading Language\acroextra{: A shading language used by the OpenGL graphics \acs{API}.}}
    ...
    \acro{HLSL}{High Level Shading Language\acroextra{: A shading language used by the DirectX graphics \acs{API}.}}
    ...
    \acro{RDG}{rendering dependency graph\acroextra{: \acs{UE4}'s graph-based scheduling system to perform whole-frame optimization of the render pipeline.}}
    ...
    \acro{fBm}{fractional Brownian motion}
\end{acronym}
