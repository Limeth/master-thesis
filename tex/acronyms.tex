...
\begin{acronym} % keep sorted using :sort
    ...
    \acro{GLSL}{OpenGL Shading Language\acroextra{: A shading language used by the OpenGL graphics API.}}
    ...
    \acro{HLSL}{High Level Shading Language\acroextra{: A shading language used by the DirectX graphics API.}}
