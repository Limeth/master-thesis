...
\section{Methods}
A controlled within-subject study including N=10 participants, was conducted to investigate whether the implemented complex replication has any effect on the scores of the \ac{5D-ASC} and the \ac{11-ASC} questionnaires.
