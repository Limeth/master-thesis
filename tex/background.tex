...
\begin{enumerate}
    ...
    \item the perceptual level,
    \item the recollective-psychodynamic level,
    \item the symbolic existential level, and
    \item the deep integral level of self-transcendence.
\end{enumerate}

See figure \ref{fig:temporal-dynamics}.
