...
\begin{figure}%
    \centering
    \subfloat[\centering Effect of \textit{StyleGAN} with varying levels of noise.\ccfootnote{schartner2020neural}{BY-SA}{A cropped version of}{NVIDIA’s generative model with noise perturbation and analogous hypothesized brain mechanism}]{\includegraphics[height=5cm]{img/reused/schartner2020neural1.png}}%
    \qquad
    \subfloat[\centering Effect of a style transfer network with varying levels of bias.\ccfootnote{schartner2020neural}{BY-SA}{}{Example output of a style-transfer network}]{\includegraphics[height=2.5cm]{img/reused/schartner2020neural2.png}}%
